...
۲۵ مرداد ۱۴۰۵
در بروزرسانی جدید فونت آریو، چند باگ در فونت برطرف شدند و چند گلیف جامانده به فونت اضافه شدند.
- رفع مشکل ناهم‌خوانی متریک ها در حالات نقاط مختلف
- تکمیل چند گلیف انگلیسی باقی‌مانده
- حذف کرنینگ اعداد فارسی برای عملکرد درست فونت در بعضی محیط ها
